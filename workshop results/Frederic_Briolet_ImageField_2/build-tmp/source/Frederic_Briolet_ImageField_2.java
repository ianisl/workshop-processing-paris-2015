...
public class Frederic_Briolet_ImageField_2 extends PApplet {
...
public void setup() 
{
  ...
  smooth(0);
  background(0);
  field = new ImageField(fieldIntensity, "belem1.jpg");
...
public String getTimestamp() 
{
    ...
    static public void main(String[] passedArgs) {
        String[] appletArgs = new String[] { "Frederic_Briolet_ImageField_2" };
        if (passedArgs != null) {
