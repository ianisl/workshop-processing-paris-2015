...
int refreshFramePeriodicity = 20; // Solution : on peut ne rafraîchir l'écran qu'une fois toutes les 'refreshFramePeriodicity' trames d'affichage (par ex. toutes les 20 trames). Cela introduit un clignotement dans l'image mais ce ne sera pas un problème si la finalité est l'impression et non l'animation
